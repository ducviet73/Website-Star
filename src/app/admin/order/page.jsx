...
const AdminOrderManagement = () => {
  ...
  useEffect(() => {
    const fetchOrders = async () => {
      try {
        const response = await axios.get("https://star-backend-ragw.onrender.com/orders");
    ...
    const fetchTotalIncome = async () => {
      try {
        const response = await axios.get("https://star-backend-ragw.onrender.com/orders/incomes/total");
  ...
  const handleStatusChange = async (orderId, newStatus) => {
    try {
      ...
      const response = await fetch(`https://star-backend-ragw.onrender.com/orders/${orderId}/status`, {
        method: "PUT",
        headers: {
  ...
  const handleDeleteOrder = async (orderId) => {
    if (window.confirm("Are you sure you want to delete this order?")) {
      try {
        await axios.delete(`https://star-backend-ragw.onrender.com/orders/${orderId}`);
  ...
  const handleFilterByStatus = async () => {
    try {
      const response = await axios.get(`https://star-backend-ragw.onrender.com/orders/status/${status}`);
      setFilteredOrders(response.data);
    } catch (error) {
  ...
  const handleFilterByDate = async () => {
    try {
      const response = await axios.get(`https://star-backend-ragw.onrender.com/orders/date/${date}`);
      setFilteredOrders(response.data);
    } catch (error) {
