...
const UserForm = ({ userId, onUserUpdated }) => {
    ...
    useEffect(() => {
        if (userId) {
            ...
            axios
                .get(`https://star-backend-ragw.onrender.com/users/${userId}`)
                .then(response => {
    ...
    const handleSubmit = (e) => {
        ...
        const request = userId
            ? axios.put(`https://star-backend-ragw.onrender.com/users/${userId}`, user) // Cập nhật người dùng
            : axios.post('https://star-backend-ragw.onrender.com/users', user); // Thêm mới người dùng
